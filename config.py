...
# The shared team inbox to monitor for regulatory emails
SHARED_MAILBOX         = _get("SHARED_MAILBOX", "regulations@reederei-nord.nl")
# "full_inbox" scans the entire inbox; "subfolder" uses Inbox/Regulations only
EMAIL_SCAN_FULL_INBOX  = _get("EMAIL_SCAN_FULL_INBOX", "true").lower() in ("true", "1", "yes")
